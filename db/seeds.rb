...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	Category.create(name:"All-Season", description: "Tires for the entire year")
	Category.create(name:"Summer", description: "Tires for the summer season")
	Category.create(name:"Winter", description: "Tires for the winter season")